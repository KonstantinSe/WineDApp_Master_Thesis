...
import { Home, AdminInterface, Hints, Subgraph, UserInterface } from "./views";
...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "WineSupplyChain", "purpose", [], localProviderPollingTime);
  ...
  return (
    <div className="App">
      ...
      <Menu style={{ textAlign: "center", marginTop: 20 }} selectedKeys={[location.pathname]} mode="horizontal">
        ...
        {/* <Menu.Item key="/hints">
          <Link to="/hints">Wein authentifizieren</Link> */}
        {/* </Menu.Item> */}
        <Menu.Item key="/userinterface">
          <Link to="/userinterface">User Interface - Wein authentifizieren</Link>
        </Menu.Item>
        <Menu.Item key="/AdminInterface">
          <Link to="/AdminInterface">Admin Interface (Proschwitz) </Link>
        </Menu.Item>
